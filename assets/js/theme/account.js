...
import {addToWishlistById} from './global/setWishlistIcon';
...
export default class Account extends PageManager {
    ...
    onReady() {
        ...
        // Check Cookie for pending wishlist additions
        if(Cookies.get('addToWl') != 'undefined'){
            addToWishlistById(storefrontAPIToken, Cookies.get('addToWl'));
            Cookies.remove('addToWl');
        }
